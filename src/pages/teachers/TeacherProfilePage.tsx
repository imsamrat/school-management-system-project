...
import { useGetTeacherByIdQuery, useDeleteTeacherMutation } from '@/features/teachers/teacherApi';
import { ArrowLeft, Edit, Trash2, BookOpen, Briefcase, User, Phone, MapPin } from 'lucide-react';
...
export default function TeacherProfilePage() {
  ...
  const { data: response, isLoading } = useGetTeacherByIdQuery(id!);
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Teacher Profile</h1>
            <p className="text-sm text-gray-500 mt-1">View and manage teacher details</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col items-center text-center">
          ...
          <p className="text-gray-500 text-sm mt-1">{teacher.teacher_id_code}</p>
          <div className="mt-3">
          ...
          <div className="w-full border-t border-gray-100 mt-6 pt-6 space-y-4 text-left">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900 capitalize">{teacher.gender}</p>
        ...
        <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-200">
          <div className="border-b border-gray-200 px-6">
            <nav className="flex space-x-6">
              ...
              <a href="#" className="py-4 px-1 border-b-2 border-transparent font-medium text-sm text-gray-500 hover:text-gray-700 hover:border-gray-300">Routine</a>
      ...
      <ConfirmDialog
        ...
        message="Are you sure you want to mark this teacher as terminated?"
